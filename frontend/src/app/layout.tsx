      ...
      <head>
        <script
          dangerouslySetInnerHTML={{
            __html: `try{let e=localStorage.getItem("theme_color")||"orange",t=localStorage.getItem("theme_font_size")||"medium",o=localStorage.getItem("theme_dark");"true"===o?document.documentElement.classList.add("dark"):"false"===o&&document.documentElement.classList.remove("dark"),document.documentElement.style.fontSize={small:"13px",medium:"14px",large:"16px"}[t]||"14px";let l={orange:"255 91 31",blue:"42 78 140",violet:"124 58 237",emerald:"5 150 105",rose:"225 29 72",amber:"217 119 6"},ld={orange:"255 110 56",blue:"96 165 250",violet:"167 139 250",emerald:"52 211 153",rose:"251 113 133",amber:"251 191 36"},r={orange:"255 230 217",blue:"216 226 242",violet:"237 224 255",emerald:"209 250 229",rose:"255 228 230",amber:"254 243 199"},rd={orange:"56 27 16",blue:"21 38 74",violet:"45 22 84",emerald:"17 54 31",rose:"84 18 29",amber:"59 42 16"};l[e]&&(document.documentElement.style.setProperty("--color-accent-light",l[e]),document.documentElement.style.setProperty("--color-accent-dark",ld[e]),document.documentElement.style.setProperty("--color-accent-soft-light",r[e]),document.documentElement.style.setProperty("--color-accent-soft-dark",rd[e]));}catch(e){}`
          }}
        />
      </head>
      <body>
