    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          <div className="fixed left-4 right-4 top-20 sm:absolute sm:inset-auto sm:top-full sm:mt-3 sm:right-0 sm:w-[320px] bg-paper border border-line rounded-2xl shadow-2xl shadow-ink/5 z-50 p-5 animate-in slide-in-from-top-3 zoom-in-95 duration-200">
            {!status.is_clocked_in ? (
              // Clock In Panel
