...
const PROVIDER_META: Record<string, {
  ...
  google: {
    ...
    color: "text-red-600", bg: "bg-red-500/10", border: "border-red-500/20",
  ...
  apple: {
    ...
    color: "text-slate-600", bg: "bg-slate-500/10", border: "border-slate-500/20",
                  ...
                  return (
                    <div key={account.id} className="flex flex-col hover:bg-bone/10 transition-all">
                      <div className="flex items-center justify-between gap-4 px-6 py-4 group">
                        ...
                        <span className="hidden sm:inline-flex items-center gap-1.5 text-[11px] font-semibold px-2.5 py-1 rounded-full bg-emerald-500/10 text-emerald-600 border border-emerald-500/20 shrink-0">
                        ...
                        <button
                          ...
                          className="w-8 h-8 flex items-center justify-center rounded-lg border border-transparent hover:border-red-500/20 hover:bg-red-500/10 text-muted hover:text-red-500 transition-all opacity-0 group-hover:opacity-100 shrink-0"
                          title="Disconnect"
                        >
        ...
        <div className="flex items-start justify-between gap-4 mb-6">
          ...
          {!showLinkForm && (
            <button
              ...
              className="btn bg-ink hover:bg-ink/90 text-paper px-5 text-[13px] flex items-center gap-2 shadow-sm shrink-0"
            >
                      ...
                      {DURATION_OPTIONS.map(d => (
                        <button key={d} type="button" onClick={() => setLinkDuration(d)}
                          className={`px-3 py-1.5 rounded-lg border text-[12px] font-semibold transition-all ${
                            linkDuration === d
                              ? "border-violet-500/50 bg-violet-500/10 text-violet-600 ring-1 ring-violet-500/50"
        ...
        {bookingLinks.length > 0 ? (
                  ...
                  <div className="px-5 py-4 border-b border-line flex items-center justify-between gap-2">
                    ...
                    <div className="flex items-center gap-1.5 shrink-0">
                      ...
                      <button
                        ...
                        className="w-7 h-7 flex items-center justify-center rounded-lg hover:bg-red-500/10 hover:text-red-500 text-muted transition-all opacity-0 group-hover:opacity-100"
                        title="Delete"
                      >
          ...
          !showLinkForm && (
            <div className="py-14 flex flex-col items-center text-center space-y-3 bg-paper border border-dashed border-line rounded-2xl">
              ...
              <button
                onClick={() => setShowLinkForm(true)}
                className="btn bg-ink text-paper hover:bg-ink/90 text-[13px] px-5 mt-1 flex items-center gap-2"
              >
