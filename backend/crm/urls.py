...
from .views import (
    ...
    PublicInvoicePaypalPayView,
    PublicInvoiceVerifyPaypalPaymentView,
    OrderViewSet,
    EventViewSet,
    NoticeViewSet,
...
urlpatterns = [
    ...
    path('public/invoice/<uuid:token>/paypal/pay/', PublicInvoicePaypalPayView.as_view(), name='public_invoice_paypal_pay'),
    path('public/invoice/<uuid:token>/paypal/verify-payment/', PublicInvoiceVerifyPaypalPaymentView.as_view(), name='public_invoice_paypal_verify_payment'),
