...
INSTALLED_APPS = [
    ...
    'attendance',
    'communications',
    'dbbackup',           # django-dbbackup for backups
...
MIDDLEWARE = [
    ...
    'companies.maintenance_middleware.MaintenanceModeMiddleware',
...
# NOTE: .strip() on all values prevents invisible newline/space characters from
# Render copy-paste from corrupting the AWS signing header (causes 500 errors).
...
if AWS_ACCESS_KEY_ID:
    ...
    aws_s3_custom_domain = env('AWS_S3_CUSTOM_DOMAIN', '').strip()
...
DBBACKUP_CLEANUP_KEEP_MEDIA = env_int('DBBACKUP_CLEANUP_KEEP_MEDIA', 14)
